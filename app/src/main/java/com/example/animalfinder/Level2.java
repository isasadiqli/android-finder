...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton firstButton = findViewById(R.id.lvl2_firstImageButton);
        ImageButton secondButton = findViewById(R.id.lvl2_secondImageButton);
        ImageButton thirdButton = findViewById(R.id.lvl2_thirdImageButton);

        if (correctCounter == 3) {
            firstButton.setImageResource(R.drawable.cow_200x200);
            secondButton.setImageResource(R.drawable.crocadile_200x200);
            thirdButton.setImageResource(R.drawable.dog_200x200);

            animalSound = MediaPlayer.create(Level2.this, R.raw.cow);
            animalType = "cow";

        } else if (correctCounter == 4) {
            firstButton.setImageResource(R.drawable.dovsan_200x200);
            secondButton.setImageResource(R.drawable.elephant_200x200);
            thirdButton.setImageResource(R.drawable.dog_200x200);

            animalSound = MediaPlayer.create(Level2.this, R.raw.dog);
            animalType = "dog";
            ...
            thirdButton.setImageResource(R.drawable.horse_200x200);

            animalSound = MediaPlayer.create(Level2.this, R.raw.chicken);
            animalType = "chicken";
        }
                ...
                question = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int i) {
                        if (i == TextToSpeech.SUCCESS) {
                            ...
                            question.speak("Find the cow, cow makes sound:", TextToSpeech.QUEUE_FLUSH, null);
                        }
                    }
                });
                break;
            case "dog":
                question = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int i) {
                        if (i == TextToSpeech.SUCCESS) {
                            question.setLanguage(Locale.ENGLISH);
                            question.speak("Find the dog, dog makes sound:", TextToSpeech.QUEUE_FLUSH, null);
            ...
            case "chicken":
                question = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int i) {
                        if (i == TextToSpeech.SUCCESS) {
                            question.setLanguage(Locale.ENGLISH);
                            question.speak("Find the chicken, chicken makes sound:", TextToSpeech.QUEUE_FLUSH, null);
